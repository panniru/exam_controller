...
--
-- Name: hall_of_fames; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
ALTER TABLE ONLY hall_of_fames ALTER COLUMN id SET DEFAULT nextval('hall_of_fames_id_seq'::regclass);
...
--
-- Name: hall_of_fames_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY hall_of_fames
    ADD CONSTRAINT hall_of_fames_pkey PRIMARY KEY (id);
